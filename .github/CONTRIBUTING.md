...
- If you want to report an issue, click [issues](https://github.com/dfinity/icp-js-bindgen/issues).
...
1. Click [create a new issue](https://github.com/dfinity/icp-js-bindgen/issues/new).
...
2. Navigate to the [repository's homepage](https://github.com/dfinity/icp-js-bindgen) in a web browser.
