...
/// construction. Anything that transforms the name here desynchronises the two and emits an
/// import of a module that was never written.
///
/// The `./declarations/` prefix is rewritten away by the JavaScript layer when the `flat`
/// option puts the declarations directly in the output directory; see `flattenImportPath` in
