...
/// A candid field name in *property* position — an object literal key, an interface member,
/// or an enum member id.
///
...
/// valid TypeScript — so the access has to become computed instead.
